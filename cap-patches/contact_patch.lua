...
contact_patch.init_capability_values = init_capability_values
contact_patch.write_attr_res_handler = write_attr_res_handler
contact_patch.read_attr_res_handler = read_attr_res_handler

contact_patch.checkininterval_capability_handler = checkininterval_capability_handler
contact_patch.fastpolltimeout_capability_handler = fastpolltimeout_capability_handler
contact_patch.identifytime_capability_handler = identifytime_capability_handler
contact_patch.deviceenabled_capability_handler = deviceenabled_capability_handler
