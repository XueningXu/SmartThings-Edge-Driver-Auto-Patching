...
motion_patch.init_capability_values = init_capability_values
motion_patch.write_attr_res_handler = write_attr_res_handler
motion_patch.read_attr_res_handler = read_attr_res_handler

motion_patch.checkininterval_capability_handler = checkininterval_capability_handler
motion_patch.fastpolltimeout_capability_handler = fastpolltimeout_capability_handler
motion_patch.identifytime_capability_handler = identifytime_capability_handler
motion_patch.deviceenabled_capability_handler = deviceenabled_capability_handler
