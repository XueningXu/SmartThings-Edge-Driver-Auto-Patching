...
presence_patch.init_capability_values = init_capability_values
presence_patch.write_attr_res_handler = write_attr_res_handler
presence_patch.read_attr_res_handler = read_attr_res_handler

presence_patch.checkininterval_capability_handler = checkininterval_capability_handler
presence_patch.fastpolltimeout_capability_handler = fastpolltimeout_capability_handler
presence_patch.identifytime_capability_handler = identifytime_capability_handler

return presence_patch
